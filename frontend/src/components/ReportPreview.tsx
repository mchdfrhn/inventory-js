...
import { EyeIcon, DocumentChartBarIcon } from '@heroicons/react/24/outline';
            ...
            <div className="p-6 border-b border-gray-200">
              <div className="flex items-center justify-between">
                <h2 className="text-xl font-semibold text-gray-900 flex items-center">
                  <DocumentChartBarIcon className="w-6 h-6 mr-2 text-blue-600" />
                  Preview Laporan: {template.name}
                </h2>
                <button
